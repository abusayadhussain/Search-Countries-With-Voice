...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recievedCountry = mainActivityIntent.getStringExtra(CountryDataSource.COUNTRY_KEY);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        CameraUpdate cameraUpdate = CameraUpdateFactory.newLatLngZoom(myCountryLocation, 6.2f);
        ...
        circleOptions.strokeColor(Color.rgb(30, 144, 255));
